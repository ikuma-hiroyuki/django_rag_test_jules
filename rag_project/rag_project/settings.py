...
load_dotenv() # This loads the .env file from the project root

# Example of how to access them (actual use will be later)
...
SECRET_KEY = 'django-insecure-z^oheyc%*l^lt)j-6dk(26q_^l=2c)=a4gmxzijc$+i9kaipbb'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True, # To find app-level templates like documents/templates/
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media' # Using Path object with /
